...
app.get("/", (req, res) => {
    res.sendFile("C:/Program Files/Ampps/www/DWES/DWES/magic/chat-project/public/index.html");
});
app.get("/login", (req, res) => {
    res.sendFile("C:/Program Files/Ampps/www/DWES/DWES/magic/chat-project/public/login.html");
});
app.get("/register", (req, res) => {
    res.sendFile("C:/Program Files/Ampps/www/DWES/DWES/magic/chat-project/public/register.html");
});
